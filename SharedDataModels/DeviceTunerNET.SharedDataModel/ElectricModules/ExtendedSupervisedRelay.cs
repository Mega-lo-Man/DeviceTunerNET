...
{
    public class ExtendedSupervisedRelay : MechanicalRelay
    {
        ...
        public ExtendedSupervisedRelay(IOrionDevice orionDevice, byte relayIndex) : base(orionDevice, relayIndex)
        {
            /*
